function shuffle_wc_replayscore_Epoch1(iident)

%%%%%
%%%%% Calculate timebin shuffle and weighted correlation
%%%%% and replay score for replays with non-overlapping bins.
%%%%% Same as shuffle_wc_replayscore_nonoverlap.m except uses MatrixEpoch1
...
%shuffle_wc_replayscore_Epoch1_Old_changedJuly2020

    load(iident,'MatrixEpoch1','Index','CandSeq')
 % time-bin shuffle and weighted correlation
    
    if size(MatrixEpoch1,2)>size(MatrixEpoch1,1)
        MatrixEpoch1 = MatrixEpoch1';
        save(iident,'MatrixEpoch1','-append')
    end
...
%         Z2 = cat(3,Z1(RandInd),Z1(:,:,1)); %testing
    ...
    disp(['Number Replays with abs(wc)>.6 & jd<.4: ' num2str(sum(abs(CandCorr)>.6 & (CandDis/size(MatrixEpoch1,2))<.4))])
    ...
    %%% Add replay score   
        ...
        CandRSEpoch1 = CandRS;    
        CandCorrEpoch1 = CandCorr;
        TmShuffleCorrEpoch1 = TmShuffleCorr; 
        CandDisEpoch1 = CandDis;
        TmShuffleDisEpoch1 = TmShuffleDis;


    %     save(iident,'CandCorrEpoch1','PosShuffleCorrEpoch1','CandDisEpoch1','PosShuffleDisEpoch1','PosShiftEpoch1','-append')
        save(iident,'CandCorrEpoch1','TmShuffleCorrEpoch1','CandDisEpoch1','TmShuffleDisEpoch1','CandRSEpoch1','-append')
        ...
        save(iident,'CandCorrEpoch1','TmShuffleCorrEpoch1','CandDisEpoch1','TmShuffleDisEpoch1','-append')
    end
end