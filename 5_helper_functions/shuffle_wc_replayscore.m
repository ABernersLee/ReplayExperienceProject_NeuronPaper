function shuffle_wc_replayscore(iident)

%%%%%
%%%%% Calculate position (column-cycle) shuffle and weighted correlation
%%%%% and replay score for replays with overlapping bins.
%%%%% Used in RunReplay_ABL_remote.m, RunReplay_ABL_wholesession.m,
%%%%% RunReplay_ABL_RemoteSleep.m, RunReplay_ABL_lapbylap.m,
%%%%% RunReplay_ABL_OneLap.m, and RunReplay_ABL_grosmark.m
%%%%%
...
%%% Add replay score  nonoverlapping 
%     Z=zeros(851, 25, YY);
%     for c=1:size(Index,2)-1
...
%     save(iident,'Radjusted','KendallR','SpearmanR','CandCorr','PosShuffleCorr','CandDis','PosShuffleDis','PosShift','CandRS','-append')
    save(iident,'CandCorr','PosShuffleCorr','CandDis','PosShuffleDis','PosShift','CandRS','-append')
